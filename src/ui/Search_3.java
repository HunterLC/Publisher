...
public class Search_3 extends JFrame {
	...
	public Search_3() {
		...
		signalLabel.setBounds(607, 50, 72, 18);
		...
		segmentComboBox.setBounds(458, 71, 109, 34);
		...
		signalComboBox.setBounds(606, 71, 102, 34);
    ...
    public Object[][] queryData(){
        List<SearchBooks> list= SearchBooksDao.getInstance().QueryAll(CombineCondition());
